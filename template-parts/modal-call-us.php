<div class="modal micromodal-slide" id="modal-call-us" aria-hidden="true">
	<div class="modal__overlay" tabindex="-1" data-micromodal-close>
		<div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
			<header class="modal__header">
				<h2 class="text-2xl font-bold transition-colors hover:text-color-primary mx-auto">Call Us</h2>
			...
			<main class="modal__content mt-3" id="modal-1-content">
				...
				<a class="group" href="tel:(808)782-8282">
					<div class="block w-full rounded-lg overflow-hidden relative bg-gradient-to-tl from-gray-200 to-gray-50 border border-gray-200 py-6 transition-all hover:border-transparent hover:shadow-lg">
						<div class="opacity-0 rounded-lg group-hover:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-br from-color-primary to-color-primary-dark"></div>
						<span class="w-full font-lato font-bold text-slate-500 text-center transition-colors duration-300 group-hover:text-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 leading-none">(808) 782-8282 &raquo;</span>
					</div>
				</a>
			</main>
		</div>
