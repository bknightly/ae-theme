...
acf_register_block_type(
  array(
    'name'              => 'toggle-content',
    'title'             => __('Toggle Content'),
    'description'       => __('Content container that toggles open and closed'),
    'render_template'   => 'blocks/toggle-content/toggle-content.php',
    'category'          => 'text',
    'supports'          => array(
      'align' => false
    ),
    'example' => array(
      'attributes' => array(
          ...
          'data' => array(
            ...
            'description'        => "Content container that toggles open and closed",
            'link_text'          => "Link Text",
            'is_preview'    => true
          )
      ),
