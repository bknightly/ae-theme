...
<main id="body">
	...
	<div class="container mx-auto -translate-y-8 lg:-translate-y-12">
		<div id="content-page" class="text-center bg-white p-7 sm:p-8 lg:p-16 rounded-xl shadow">
			<h2 class="page-title text-2xl mb-8"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'leh-theme' ); ?></h2>
			<p class="mb-8"><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'leh-theme' ); ?></p>
